defmodule Sequencer do
  ...
  @v_lesu_rodilas_elochka "|--c4-a4-a4-g4-a4-f4-c4-c4-c4-a4-a4-b4-g4-c5>>-c5-d4-d4-b4-b4-a4-g4-f4-c4-a4-a4-g4-a4-f4>>-e4-d4-d4-b4-b4-a4-g4-f4-c4-a4-a4-g4-a4-f4>>-"
  def run() do
    ...
    context =
      ...
      |> Context.put_element(:main, :filter, Biquad.lowpass(@rate, 880, 0.1))
